...
const ApartmentsTable = () => {
  ...
  const menuItems = [
    { name: "All Requests (2490)", path: "/dashboard/help-requests" },
    { name: "Maintenance (50)", path: "/dashboard/Maintenance (50)" },
    { name: "Facility Care (1256)", path: "/dashboard/Facility Care (1256)" },
    { name: "Users (1256)", path: "/dashboard/Users (1256)" }
  ];
